        ...
        <ul className="navbar-nav flex-row d-none d-sm-flex">
          <li className="nav-item me-3 me-lg-4  px-3">
            <Link href="/discover" passHref>
              <NavLink
                active={
                  !(
                    router.pathname.match("favourites") ||
                    router.pathname.match("latest")
                  )
                }
              >
                Popular
          ...
          <li className="nav-item me-3 me-lg-4 px-3">
            <Link href="/discover/latest" passHref>
              <NavLink active={router.pathname.includes("latest")}>
                Latest
              </NavLink>
            </Link>
          </li>
          ...
          {isAuth() && (
            <li className="nav-item me-3 me-lg-4 px-3">
              <Link href="/discover/favourites" passHref>
                <NavLink active={router.pathname.includes("favourites")}>
                  Favourites
                </NavLink>
              </Link>
            </li>
